	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if("true".equals(all)){
			...
			if (StringUtil.isNotEmpty(s_releaseDataStr)) {
				s_releaseDataStr=new String(s_releaseDataStr.getBytes("ISO-8859-1"),"UTF-8");
		...
		try {
			...
			String pageCode = this.genPagation(total, Integer.parseInt(page), Integer.parseInt(bundle.getString("pageSize")));
